...
import by.diplom.workspace.worker.position.exception.DepartmentPositionAlreadyExistsException;
import by.diplom.workspace.worker.position.exception.DepartmentPositionNotFoundException;
...
import by.diplom.workspace.worker.position.service.DepartmentPositionService;
